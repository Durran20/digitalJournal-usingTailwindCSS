...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="user.png" alt="" width="50" height="40">
      <h2>Registration</h2>
    </div>

      <div class="">
        <h4 class="mb-3">Enter Your Details</h4>
        <form action="registerdetails.php" method="POST" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
        ...
        <a href="index.php" class="w-100 btn btn-primary btn-lg">Already Registered? Sign In!</a>
      </div>
    </div>
  </main>
